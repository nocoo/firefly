...
| `icon-rounded.png` | Rounded presentation for app-controlled surfaces and README |
...
The generator uses rounded tiles for the 24/80 px app logos and social image;
square tiles for the 32 px icon, 180 px touch icon, and verified 16/32/48 px ICO.
