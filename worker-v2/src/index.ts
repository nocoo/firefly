/**
 * firefly Worker v2 — Cloudflare Worker with native D1 binding.
 *
 * Normalized API with /api/v1/ prefix. Replaces the original worker
 * (worker/) which remains intact as rollback backup.
 *
 * Routes:
